...
export interface LoggerF {
    info(msg: string, className: string, level: LogLevelEnum.INFO ,filename: string, type: LogTypeEnum.SERVICE): void;
    ...
    warn(msg: string, className: string ,level: LogLevelEnum,type: LogTypeEnum.SERVICE): void;
